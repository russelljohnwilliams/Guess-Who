...
describe('guessWho', function(){
  ...
  beforeEach(function(){
    ...
    gerry = new Character({name:'Frank', hair:'yes', glasses:'no', beard:'no', hat:'yes'});
    glen = new Character({name:'Barbara', hair:'yes', glasses:'yes', beard:'yes', hat:'no'});    
    deb = new Character({name:'Frank', hair:'yes', glasses:'no', beard:'no', hat:'yes'});
    roy = new Character({name:'Barbara', hair:'yes', glasses:'yes', beard:'yes', hat:'no'});
